...
const services = [
  {
    ...
    image: "https://res.cloudinary.com/upwork-cloud/image/upload/c_scale,w_1000/v1709881319/catalog/1435523690771054592/vz9dsixirjqfq5bnab96.webp",
  },
  {
    id: 2,
...
const Page = () => {
  ...
  <div
    ...
    style={{
      backgroundImage: 'url("https://neotechdevs.com/wp-content/uploads/2022/08/pexels-pixabay-267350-scaled.jpg")',
  ...
  >
    <div 
      ...
      style={{
        backgroundImage: 'linear-gradient(180deg, rgba(0,0,0,0.9) 0%, rgba(0,0,0,0.9) 100%)'
      }}
    ></div>
  </div>
</div>
...
<motion.div {...textAnimation}>
  <h2
    className="pb-4 text-[20px] lg:text-[23px] md:text-[16px] sm:text-[14px] leading-[1.8em] text-white font-semibold font-montserrat"
  >
    <p className="text-shadow-md">
    Our Digital Marketing team is ready to take your business to the next level.
...
>
Businesses of all kinds have seen new opportunities for growth thanks to the increasing use of social media and other web technologies, but many struggle to get their message out.
</motion.h3>
...
>
Be heard through the noise with our marketing services. These services provide you access to our content creators, photographers, digital designers, and more. Let us handle generating traffic to your business or project, so you can focus on operations.
...
>
We have experience transforming brands and can help you too! All of our clients are provided with before and after analytics to demonstrate the accelerated business growth achieved with the package selected.
</motion.h2>
<p className="text-gray-400 text-sm ml-2">(Actual Results May Vary*)</p>
      </div>
    </div>
    ...
    >
      <div className="p-6 mb-6 rounded bg-black bg-opacity-50">
        <h2 className="mb-3 text-2xl font-extrabold">   We speak marketing so you don&apos;t have to.</h2>
