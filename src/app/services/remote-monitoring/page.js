...
const services = [
  ...
  },
  {
    ...
    image: "https://encrypted-tbn3.gstatic.com/images?q=tbn:ANd9GcRoXv3Azd8HiJxg5-a8LJQsOCPATV3Vq2xHk06arIV4-deAUcMG",
  },
  {
    id: 3,
...
const Page = () => {
  ...
  <div
    ...
    style={{
      backgroundImage: 'url("https://neotechdevs.com/wp-content/uploads/2022/08/remote-monitoring-2-scaled.jpg")',
      height: '2191.76px',
      transform: 'translate(0px, 206.1px)'
    }}
  >
    <div 
...
>
  Take the stress out of managing your own PCs and other network-enabled connected devices with our remote monitoring packages. Available and tailored to your needs to ensure you are up to date and secure.
</motion.h2>
...
>
Ensure your devices are secured. Inquire for our monitoring packages to secure your Home or Business.
</motion.h2>
    ...
    >
      <div className="p-6 mb-6 rounded bg-black bg-opacity-50">
        <h2 className="mb-3 text-2xl font-extrabold">  Looking for 24/7 network & device monitoring?</h2>
        <p className="mb-4 text-gray-300 font-secondary">
        Our engineers will be glad to assist with all your monitoring needs. 
      We are always available to help and troubleshoot remote devices and 
      provide extensive reports and life cycle upgrade packages.
        </p>
        <a
  href="#"
...
>
  ...
  <div className="md:pl-20 lg:ml-10 md:ml-6 md:pt-6 lg:mt-14">
    ...
    {[
      { 
        title: "Device Audit", 
        items: ["All Network Devices", "PC & Mac Agents", "Printer & IoT Monitoring", "Network Services Monitoring",  "More"] 
      },
      { 
        title: "Customer Portal", 
        items: ["Ticketing System", "Chat System", "Patch Releases", "Downtime Schedules", "More"] 
      },
      { 
        title: "Alerts", 
        items: ["Device Alerts", "Audit Reports", "Upgrade Paths", "Decommission Reports", "More"] 
      },
    ].map((section, index) => (
        <motion.div
          key={index}
