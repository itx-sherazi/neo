...
Fully Licensed, Insured & Ready to take Flight.
    ...
    >
      <div className="p-6 mb-6 rounded bg-black bg-opacity-50">
        <h2 className="mb-3 text-2xl font-extrabold"> Looking for Drone Work?</h2>
...
<div className="md:pl-20 md:ml-6 md:pt-6 lg:mt-14">
  <div className="grid grid-cols-1 md:flex md:gap-6">
    {[
      { 
        title: "Photography", 
        items: ["Real Estate", "Restaurants", "Promotional Content", "Events", "More"] 
      },
      { 
        title: "Videography", 
        items: ["Motion Picture", "Hyperlapses", "Promotional Content", "Commericals", "More"] 
      },
      { 
        title: "Editing & Composition", 
        items: ["Introductions", "Color Grading", "Outtros", "Platform Based Rendering", "More"] 
      },
    ].map((section, index) => (
        <motion.div
          key={index}
