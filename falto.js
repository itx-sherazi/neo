...
<motion.div
    ...
    >
      ...
      <section className="py-12 bg-black text-white">
        ...
        <motion.h1
      initial={{ opacity: 0, x: 100 }} // Pehle hidden + right side
      whileInView={{ opacity: 1, x: 0 }} // Jab screen ka 50% viewport par aayega
      transition={{ duration: 1.5, ease: "easeOut" }} // Smoothly left se apni jagah par aayega
      viewport={{ once: true, amount: 0.5 }} // Scroll hone par sirf ek baar chalega
